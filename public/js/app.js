...
var store = new __WEBPACK_IMPORTED_MODULE_0_vuex__["a" /* default */].Store({
  ...
  actions: {
    loadTodos: function loadTodos(_ref) {
      ...
      window.axios.get('/todos').then(function (_ref2) {
        var data = _ref2.data;
    ...
    addTodo: function addTodo(_ref3, todo) {
      var commit = _ref3.commit;

      window.axios.post('/todos', todo).then(function (_ref4) {
        var data = _ref4.data;

        commit('addTodo', data);
      });
    },
    removeTodo: function removeTodo(_ref5, id) {
      var commit = _ref5.commit;

      var self = this;
      window.axios.delete('/todos/' + id).then(function (_ref6) {
        var data = _ref6.data;

        commit('removeTodo', id);
      });
    },
    toggleDone: function toggleDone(_ref7, id) {
      var commit = _ref7.commit;

      var index = this.state.items.findIndex(function (todo) {
        return todo.id == id;
      });
      var todo = this.state.items[index];
      window.axios.put('/todos/' + id, { done: !todo.done }).then(function (_ref8) {
        var data = _ref8.data;
  ...
  mutations: {
    updateTodos: function updateTodos(state, todos) {
      state.items = todos;
    },
    ...
    toggleDone: function toggleDone(state, todo) {
      var index = state.items.findIndex(function (todo) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TodoInput_vue__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TodoItem_vue__ = __webpack_require__(48);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: __WEBPACK_IMPORTED_MODULE_2_vuex__["a" /* default */].mapState(['items', 'loading']),
  components: {
    'todo-input-component': __WEBPACK_IMPORTED_MODULE_0__TodoInput_vue___default.a,
    'todo-item-component': __WEBPACK_IMPORTED_MODULE_1__TodoItem_vue___default.a
  },
  mounted: function mounted() {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "box" }, [_c("todo-input-component")], 1),
    _vm._v(" "),
    _c(
      "table",
