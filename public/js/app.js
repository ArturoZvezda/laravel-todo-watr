    ...
    mounted: function mounted() {
        ...
        window.axios.get('/todos').then(function (_ref) {
            ...
            for (var item in data) {
                ...
                _this.items.push({ text: data[item].text, done: data[item].done, id: data[item].id });
            }
        });
    },
    ...
    methods: {
        addTodo: function addTodo(todo) {
            ...
            if (text !== '') {
                ...
                window.axios.post('/todos', todo).then(function (_ref2) {
                    var data = _ref2.data;
        ...
        removeTodo: function removeTodo(id) {
            ...
            var self = this;
            window.axios.delete('/todos/' + id).then(function (_ref3) {
                var data = _ref3.data;

                self.items = _this3.items.filter(function (item) {
                    return item.id !== id;
                });
            });
        },
        toggleDone: function toggleDone(todo) {
            ...
            var self = this;
            window.axios.put('/todos/' + todo.id, { done: todo.done }).then(function (_ref4) {
                var data = _ref4.data;
            });
        }
    }
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c(
      "div",
      { staticClass: "box" },
      [_c("todo-input-component", { on: { "add-todo": _vm.addTodo } })],
      1
    ),
    _vm._v(" "),
    _c(
      ...
      _vm._l(_vm.items, function(todo, index) {
        return _c("todo-item-component", {
          ...
          on: { "remove-todo": _vm.removeTodo, "toggle-done": _vm.toggleDone }
        })
      })
    )
  ])
